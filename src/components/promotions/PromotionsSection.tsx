          ...
          {promotions.map((card: any, index: number) => {
            ...
            return (
              <a
                ...
                className="w-full"
              >
                <Card className="flex h-[140px] flex-col overflow-hidden rounded-xl border border-neutral-800 bg-[#1A1A1A90] shadow-[0_0_10px_#FF003D]">
                  <CardContent className="flex flex-1 flex-col p-4">
                    ...
                    <div className="flex h-full flex-col text-white">
                      <div className="flex h-full flex-col justify-start">
                        <p className="text-lg leading-tight font-black text-[#FF003D] uppercase">
                          {card.content1}
                        </p>
                        ...
                        {card.footer && (
                          <p className="mt-1 text-sm font-medium text-gray-400 uppercase">
                            {card.footer}
                          </p>
                        )}
                      </div>
