              ...
              <div className="flex justify-center gap-8 p-6">
                <Link href="#" className="text-white">
                  <svg
                    ...
                    fill="white"
                  >
                    <path d="M22 12.07C22 6.26 17.19 1.58 11.25 1.58C5.31 1.58 0.5 6.26 0.5 12.07C0.5 17.33 4.34 21.66 9.38 22.42V15.05H6.75V12.07H9.38V9.79C9.38 7.19 10.92 5.74 13.32 5.74C14.47 5.74 15.67 5.95 15.67 5.95V8.45H14.35C13.04 8.45 12.62 9.29 12.62 10.14V12.07H15.55L15.08 15.05H12.62V22.42C17.66 21.66 22 17.33 22 12.07Z" />
                  </svg>
                </Link>
                <Link href="#" className="text-white">
                  <svg
                ...
                <Link href="#" className="text-white">
                  <svg
                    ...
                    fill="white"
                  >
                    <path d="M22.46 6C21.69 6.35 20.86 6.58 20 6.69C20.88 6.16 21.56 5.32 21.88 4.31C21.05 4.81 20.13 5.16 19.16 5.36C18.37 4.5 17.26 4 16 4C13.65 4 11.73 5.92 11.73 8.29C11.73 8.63 11.77 8.96 11.84 9.27C8.28 9.09 5.11 7.38 3 4.79C2.63 5.42 2.42 6.16 2.42 6.94C2.42 8.43 3.17 9.75 4.33 10.5C3.62 10.5 2.96 10.3 2.38 10V10.03C2.38 12.11 3.86 13.85 5.82 14.24C5.19 14.41 4.53 14.44 3.89 14.31C4.43 16 6 17.26 7.89 17.29C6.43 18.45 4.58 19.13 2.56 19.13C2.22 19.13 1.88 19.11 1.54 19.07C3.44 20.29 5.7 21 8.12 21C16 21 20.33 14.46 20.33 8.79C20.33 8.6 20.33 8.42 20.32 8.23C21.16 7.63 21.88 6.87 22.46 6Z" />
                  </svg>
                </Link>
              </div>
            </SheetContent>
