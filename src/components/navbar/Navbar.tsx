...
export default function Navbar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50">
        <div className="flex items-center justify-between border-b border-neutral-800 bg-black px-4 py-4 shadow-md sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link href="https://wager.rubywager.com">
      ...
      {/* Login Modal (External POST) */}
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            <button
              className="mb-4 ml-auto block text-sm text-gray-500 hover:text-gray-700"
            ...
            >
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="mt-1 w-full rounded border border-gray-300 px-3 py-2 shadow-sm focus:border-[#c19652] focus:outline-none focus:ring-[#c19652]"
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                className="w-full rounded bg-[#c19652] px-4 py-2 text-white hover:bg-[#a67e3f]"
              >
                Login
              </button>
            </form>
