...
export function HeroCarousel() {
  ...
  return (
    <section className="relative flex h-[360px] items-center justify-center overflow-hidden bg-black sm:h-[400px] lg:h-[500px]">
      ...
      {/* MOBILE VERSION */}
      <div className="relative z-10 mx-auto flex min-h-full w-full max-w-7xl items-center px-4 py-4 sm:hidden">
        <div className="w-full max-w-xl text-center">
          {/* Hide all content for first and second slides, only show button at bottom */}
          {(currentSlide === 0 || currentSlide === 1) && (
            <div
              className="absolute left-1/2 -translate-x-1/2 transform bottom-[38px]"
            >
              <Button
                size="lg"
                onClick={handleJoinNowClick}
                className="blink-button rounded-lg bg-yellow-500 px-10 py-3 text-lg font-bold text-white shadow-lg transition-all duration-300 hover:bg-yellow-400 hover:shadow-xl"
              >
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 z-20 rounded-full bg-black/50 p-1.5 text-white transition-colors hover:bg-black/70 sm:left-4 sm:p-2 top-[calc(50%+40px)] -translate-y-1/2 sm:top-1/2"
      >
        <ChevronLeft className="h-5 w-5 sm:h-6 sm:w-6" />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-2 z-20 rounded-full bg-black/50 p-1.5 text-white transition-colors hover:bg-black/70 sm:right-4 sm:p-2 top-[calc(50%+40px)] -translate-y-1/2 sm:top-1/2"
      >
