    ...
    <>
      ...
      <div className="relative hidden h-[600px] w-full overflow-hidden lg:block">
        <div
          ...
          style={{
            backgroundImage: `url('/why-ruby.png')`,
