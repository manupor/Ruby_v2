  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-20">
      ...
      <p className="mb-16 text-center text-lg text-gray-300 max-w-2xl mx-auto">
        Explore key stories in tennis, cricket, boxing, and basketball. From clay court battles to IPL
        thrillers and NBA legacy moments — stay updated with RubyWager.
      </p>
            ...
            >
              ...
              <ChevronDown
                className={`h-6 w-6 text-white transform transition-transform duration-300 ${
                  openSlug === post.slug ? 'rotate-180' : ''
                }`}
              />
            </button>
            <div
              className={`transition-all duration-500 ease-in-out overflow-hidden ${
                openSlug === post.slug ? 'max-h-[5000px] opacity-100' : 'max-h-0 opacity-0'
              }`}
            >
              <img
                src={post.image}
